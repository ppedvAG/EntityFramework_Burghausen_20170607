namespace HalloCodeFirstFromDatabase
{
    ...
    public partial class NorthwindContext : DbContext
    {
        ...
        public virtual DbSet<KDUs2> KDUs2 { get; set; }
        public virtual DbSet<KundenAM> KundenAMs { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<KDUs2>()
                .Property(e => e.CustomerId)
                .IsFixedLength();

            modelBuilder.Entity<KDUs2>()
                .Property(e => e.TextSpalte)
                .IsUnicode(false);

            modelBuilder.Entity<KundenAM>()
                .Property(e => e.CustomerID)
                .IsFixedLength();
